...
try {
    // Update query untuk melakukan join dengan tabel categories dan pencarian
    $stmt = $pdo->prepare("
...
<main class="flex">
    ...
    <div class="container mx-auto px-6 pt-20 w-4/5">
        ...
        <a href="add_product.php" class="text-blue-500"><span class="font-bold text-lg">+</span>Add New Product</a>
            ...
            <tbody>
                <?php foreach ($products as $product): ?>
                    <tr class="text-center">
                        ...
                        <td class="border"><?php echo htmlspecialchars($product['category_name']); ?></td>
